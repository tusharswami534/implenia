...
const Hero = () => {
  return (
    <div className="flex justify-center items-center min-h-[662px] bg-cover bg-center bg-no-repeat relative bg-hero max-xl:px-5">
      <Image
        src={"/assets/images/png/hero-image.png"}
        alt="hero-image"
        width={375}
        height={562}
        className="absolute hero-image pointer-events-none top-[61%] max-xl:top-[32%] max-xl:max-w-[250px] max-xl:max-h-[400px] -translate-y-1/2 left-0"
      />
