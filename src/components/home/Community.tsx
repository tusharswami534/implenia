...
const Community = () => {
  return (
    <div className="bg-gray pt-[129px] pb-[130px] max-lg:py-28 max-md:py-20 max-sm:py-16 px-5">
      <div className="container max-w-[1108px] relative mx-auto">
        <Heading myClass="pb-[144px]" text="WHAT OUR COMMUNITY SAYS" />
        <div>
          <Swiper
            className="mySwiper"
            modules={[Navigation]}
            ...
            {COMMUNITY_LIST.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="max-w-[795px] flex flex-col justify-center mx-auto">
                  <p className="text-[100px] text-center leading-[125px] mb-[-50px] text-orangeLight tracking-[-0.66px]">
                    “
                  </p>
                  ...
                  <div className="flex items-center gap-3.5 max-w-[710px] mt-[30px] ml-auto w-full">
                    <Image
                      src={item.profile}
                      alt="profile"
                      width={80}
          ...
          <button className="swiper-next absolute top-[62%] z-10 left-0">
            <NextIcon />
          </button>
          <button className="swiper-prev absolute right-0 top-[62%] z-20 ">
            <PrevIcon />
          </button>
        </div>
      </div>
