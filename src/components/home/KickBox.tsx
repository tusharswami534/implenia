...
const KickBox = () => {
  return (
    <div className="pt-[129px] pb-[144px] max-lg:py-28 max-md:py-20 max-sm:py-16 px-5">
      <div className="container max-w-[1090px] mx-auto max-lg:justify-center flex flex-col max-lg:items-center">
        <Heading
          myClass="pb-[17px] max-md:pb-2.5 max-sm:pb-2 max-lg:text-center"
          text="KICKBOX PROCESS"
        />
        <Description
          myClass="pb-[75px] max-lg:pb-[40px] max-md:pb-[30px] max-lg:text-center"
